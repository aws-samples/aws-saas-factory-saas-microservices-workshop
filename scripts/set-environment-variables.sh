...
export CDK_PARAM_TLS_CERT_ISTIO="$(base64 certs/ingressgw_example_com.crt | tr -d '[:space:]')"
export CDK_PARAM_TLS_KEY_ISTIO="$(base64 certs/ingressgw_example_com.key | tr -d '[:space:]')"
